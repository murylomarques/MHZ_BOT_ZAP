...
async function insertPickupRequest({ contactId, waId, pickupDate, period, address, contactPhone }) {
  await getPool().query(
    `insert into pickup_requests (contact_id, wa_id, pickup_date, period, address, contact_phone)
     values ($1, $2, $3, $4, $5, $6)`,
    [contactId, waId, pickupDate, period, address, contactPhone]
  );
}
